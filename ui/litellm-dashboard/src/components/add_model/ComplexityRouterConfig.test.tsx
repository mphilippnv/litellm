...
describe("edit tiers", () => {
  ...
  // One pass over the editing surface: row limits, rules following a rename (they point by NAME,
  // unlike the id-based pointers), and every input a custom set forces off disabled with a reason.
